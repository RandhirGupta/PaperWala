...
/**
 * Helps with formatting the output. Check [DefaultOutputFormatter] for an example.
 */
interface OutputFormatter {

    val formattedText: String

    fun getFormattedElement(topNode: Element): Element

    fun getFormattedTextForWebView(topNode: Element): String
