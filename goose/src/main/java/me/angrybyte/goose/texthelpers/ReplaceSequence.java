...
/**
 * Wraps the usage of making multiple string replacements in an ordered sequence. For Example... instead of doing this over and over:</p>
 * <blockquote>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * </blockquote> You can use a <code>ReplaceSequence</code> like this:</p> <blockquote>
 * 
 * <pre>
 *     static final betterReplacements = ReplaceSequence
 *     .{@link #create(String, String) create}("e", "E").{@link #append(String, String) append}(" ", "_").{@link #append(String) append}("^\\s+$");
 * 
 ...
 * Each matcher is {@link Matcher#reset(CharSequence) reset} with the input specified in the {@link #replaceAll(String)} method.
 * </p>
...
public class ReplaceSequence {
    ...
    /**
     * Creates a new <code>ReplaceSequence</code> with the first pattern to be replaced with the specified <code>replaceWith</code>
     * parameter.
     *
    ...
    public static ReplaceSequence create(String firstPattern, String replaceWith) {
        return new ReplaceSequence(StringReplacement.compile(firstPattern, replaceWith));
    }
